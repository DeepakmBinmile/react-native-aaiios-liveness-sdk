 ...
 */
@property(nonatomic, copy, nullable) NSArray<NSString *> *detectionActions;
...
@property(nonatomic, copy, nullable) void (^detectionReadyBlk)(RNAAILivenessView *rawVC, AAIDetectionType detectionType, NSDictionary *info);

/// Called whenever a new video frame is detected.
@property(nonatomic, copy, nullable) void (^frameDetectedBlk)(RNAAILivenessView *rawVC, AAIDetectionType detectionType, AAIActionStatus status, AAIDetectionResult result, NSDictionary *info);
...
@property(nonatomic, copy, nullable) void (^detectionTypeChangedBlk)(RNAAILivenessView *rawVC, AAIDetectionType toDetectionType, NSDictionary *info);

/// Call when liveness detection success.
@property(nonatomic, copy, nullable) void (^detectionSuccessBlk)(RNAAILivenessView *rawVC, AAILivenessResult *result);

/// The remaing detection time of the current detection type, this block is called about once per second.
@property(nonatomic, copy, nullable) void (^detectionRemainingTimeBlk)(RNAAILivenessView *rawVC, AAIDetectionType detectionType, NSTimeInterval remainingTime);
...
/// */
///
@property(nonatomic, copy, nullable) void (^detectionFailedBlk)(RNAAILivenessView *rawVC, NSDictionary *errorInfo);
